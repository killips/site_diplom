  ...
  <div class="container-fluid">
    ...
    <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-2">
      <ul class="nav navbar-nav mynav">
        <li><a href="<?php if($_SERVER['SCRIPT_NAME']=="/index.php") echo "#"; else echo "/";?>">Главная<span class="sr-only">(current)</span></a></li>
        <li><a href="<?php if($_SERVER['SCRIPT_NAME']=="/pages/test.php") echo "#"; else echo "/pages/test.php";?>">Тесты</a></li>
      <?php if(isset($_SESSION["id_user"])) echo "  <li class='dropdown'>
          <a href='' class='dropdown-toggle' data-toggle='dropdown' role='button' aria-expanded='false'>Иван Иванов <span class='caret'></span></a>
          <ul class='dropdown-menu' role='menu'>
            <li><a href='office'>Личный кабинет</a></li>
            <li class='divider'></li>
            <li><a href='minetest'>Мои тесты</a></li>
          </ul>
        </li>" ?>
        <li><a href="<?php if($_SERVER['SCRIPT_NAME']=="/pages/ourcontact.php") echo "#"; else echo "/pages/ourcontact.php";?>">Контакты</a></li>
      </ul>
      ...
      <div class="modal-body">
        ...
        if (!empty($_POST["button_reg"])) {
          ...
          if (strlen($email)<3) $success=false;
            ...
            else $success=newUser($email,$nick_name,md5($password_1));
        ...
        <form class="form-horizontal" method="POST" action="">
          <fieldset>
            <div class="form-group">
              <label for="inputEmail" class="col-lg-2 control-label">Ник</label>
              <div class="col-lg-10">
                <input type="text" class="form-control" id="inputEmail" placeholder="Ник" name="nick_name">
              </div>
            </div>
            <div class="form-group">
